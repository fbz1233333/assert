...
fxcc::graph::gles3::Shader::Shader(const std::string &vCode, const std::string &fCode)
...
unsigned int fxcc::graph::gles3::Shader::GetLocation(const std::string &name) const
{
